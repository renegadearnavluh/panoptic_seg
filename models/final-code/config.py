...
def add_panopticfcn_config(cfg):
    ...
    cfg.MODEL.FPN.SHOULD_FORWARD_FUSED_FEAT  = False # True or False to forward fused feature to the next stage: only valid for mid fusion and mid-late 
    ...
    cfg.MODEL.KERNEL_HEAD.DCOORD          = False
