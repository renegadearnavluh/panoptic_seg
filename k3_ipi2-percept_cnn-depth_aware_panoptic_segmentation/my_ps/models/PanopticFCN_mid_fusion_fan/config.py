...
def add_panopticfcn_config(cfg):
    ...
    cfg.MODEL.FUSION_STAGE               = "LATE_FUSION" # "LATE_FUSION" or "MID_FUSION"
    cfg.MODEL.SHOULD_FORWARD_FUSED_FEAT  = False # True or False to forward fused feature to the next stage
    cfg.MODEL.FPN.TYPE                   = "FPN" # "FPN" or "FAN" or "SEPFPN"
    ...
    cfg.MODEL.DEPTH_MODALITY.FUSION_TYPE = "mean" # "mean" or "concat" or "residual_excite"
