from .fused_backbone_utils import build_resnet_fusion_fpn_p5_backbone
import torch
...
class PanopticFCN(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if cfg.MODEL.FUSION_STAGE == "MID_FUSION":
            self.backbone = build_resnet_fusion_fpn_p5_backbone(cfg, None)
            ...
            raise ValueError(f"Unsupported fusion type: {cfg.MODEL.FUSION_STAGE}")
    ...
    def forward(self, batched_inputs):
        ...
        * Other information that's included in the original dicts, such as:
        ...
        if self.cfg.MODEL.DEPTH_MODALITY.ENABLED:
            ...
            if self.cfg.MODEL.FUSION_STAGE == "MID_FUSION":
