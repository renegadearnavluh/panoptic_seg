...
def build_resnet_mid_fusion_fan_backbone(cfg, input_shape):

    if input_shape is None:
        input_shape = ShapeSpec(channels=len(cfg.MODEL.PIXEL_MEAN))

    bottom_up = build_resnet_with_fusion_backbone(cfg, input_shape)
...
def build_resnet_fan_backbone(cfg, input_shape):
    """
    Args:
