...
from my_ps.models.panopticfcn.resnet import build_resnet_backbone
...
def build_resnet_fpn_p5_backbone(cfg, input_shape: ShapeSpec, modal="color"):
    """
    ...
    """
    bottom_up = build_resnet_backbone(cfg, input_shape, modal)

    if modal == "color":
        in_features = cfg.MODEL.FPN.IN_FEATURES
    elif modal=="depth":
        in_features = cfg.MODEL.FPN.DEPTH_IN_FEATURES
...
def build_backbone(cfg, input_shape=None, modal="color"):
    """
    ...
    backbone = build_resnet_fpn_p5_backbone(cfg, input_shape, modal)
