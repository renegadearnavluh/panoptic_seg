...
from my_ps.utils.demo.defaults import DefaultPredictor
from my_ps.utils.demo.visualizer import ColorMode, Visualizer
...
class VisualizationDemo(object):
    ...
    def run_on_image(self, image, task):
        ...
        # To-do Need to fix instance segmentation with list index out of range error
